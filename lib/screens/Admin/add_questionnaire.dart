            ...
            if (_answersformKey.currentState.validate()) {
              if (int.tryParse(_score) is int) {
                ...
                final snackBar = SnackBar(
                  ...
                  content: Text('Enter an integer score'),
                  duration: Duration(seconds: 2),
                );
        ...
        children: [
          ...
          button('Add Evaluation', () {
            if (_evaluationsformKey.currentState.validate()) {
              if (int.tryParse(_from) is int && int.tryParse(_to) is int) {
                setState(() {
                  _evaluations.add({
                ...
                final snackBar = SnackBar(
                  ...
                  content: Text('From and To must be integer'),
                  duration: Duration(seconds: 2),
                );
