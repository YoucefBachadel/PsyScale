...
class _QuizState extends State<Quiz> {
  ...
  saveToHestory(String _message) async {
    if (widget.userUid != 'gest') {
      setState(() {
        isLoading = true;
      });
      widget.history.add({
        ...
        'date': Timestamp.now(),
        'score': '$_totalScore/$_maxScore',
        'message': _message,
      });

      UsersServices(useruid: widget.userUid).updateUserHestory(widget.history);
